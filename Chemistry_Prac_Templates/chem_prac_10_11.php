...
<div class="tabs">
    ...
    <button class="tab-button active" onclick="window.location.href='https://chem-sim-wnth.vercel.app/experiment6';">
...
<div class="button-container">
                    <button class="styled-button" onclick="window.location.href='Chem_Prac_12.php'">Próxima práctica</button>
                    <button class="styled-button" onclick="window.location.href='Chem_Prac_9.php'">Práctica anterior</button>
